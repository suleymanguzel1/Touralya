...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 45775b24-bc68-459c-87fc-709905a6d2fd
```

> `45775b24-bc68-459c-87fc-709905a6d2fd` is the password of the certificate, you can change it to any password you want.
...
The application needs a database. Run the following command in the `Touralya` directory to migrate the database and seed the initial data. This step is automatically done when you create a new solution, if you didn't especially disabled it.
